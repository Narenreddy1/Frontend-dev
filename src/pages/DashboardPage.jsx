    ...
    <Layout>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 mt-2 px-2 gap-4">
        ...
        <div className="w-full sm:w-auto">
          <input
            type="date"
            className="sm:w-auto border border-gray-300 bg-white rounded-lg px-4 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 transition-shadow"
          />
        </div>
      </div>
