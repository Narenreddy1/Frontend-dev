...
const Sidebar = () => {
  ...
  return (
    <aside className="w-55 bg-[#083638] text-white h-full">
      <div className="bg-white flex justify-center items-center h-12 px-1 py-3">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <button
              ...
              className="w-full flex items-center justify-between px-1 py-2 text-sm font-medium hover:bg-[#1a4f51] rounded transition duration-150"
            >
